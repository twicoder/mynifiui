...
nf.Canvas = (function () {
  ...
  return {
    ...
    init: function () {
      ...
      // $.when(authoritiesXhr, configXhr).fail(function (authoritiesResult, configResult) {
      //   // console.log("authoritiesResult:");
      //   // console.log(authoritiesResult);
      //   //
      ...
      //   //
      //   // }).fail(nf.Common.handleAjaxError);
      // }).done(nf.Common.handleAjaxError);
    },
